  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        updateFormInputs: function () {
            ...
            else if (this.startDate.isSame(this.maxDate) || this.startDate.isBefore(this.endDate)) {
        ...
        renderDropdowns: function (selected, minDate, maxDate, side) {
             if( side == 'left'){
               maxDate=moment();
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.showDropdowns) {
                dateHtml = this.renderDropdowns(calendar[1][1], minDate, maxDate, side);
            }
